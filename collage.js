//https://github.com/unsetbit/collage
...
var endpoint = 'https://www.reddit.com/r/all/search.json';
...
function getEmbed(collage, options){
	...
	iframeContent += '<script type="text/javascript" src="https://www.reddit.com/r/' +
...
var queryTweets = (function(){
	var endpoint = 'https://search.twitter.com/search.json';
